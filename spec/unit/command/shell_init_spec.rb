...
describe ChefCLI::Command::ShellInit do
      ...
      let(:command_descriptions) do
        {
          ...
          "env" => "Prints environment variables used by ChefCLI",
  ...
  context "for fish" do
    ...
    describe "generating auto-complete" do
      ...
      let(:expected_completion_function) do
        <<~END_COMPLETION
          # Fish Shell command-line completions for ChefCLI
          ...
          complete -c chef -f -n '__fish_chef_no_command' -a env -d "Prints environment variables used by ChefCLI"
