...
STR='[2024-12-06T09:05:46+00:00] WARN: Please install an English UTF-8 locale for Chef Infra Client to use, falling back to C locale and disabling UTF-8 support. 5.6.15'
SUB='5.6.15'
if [[ "$STR" != *"$SUB"* ]]; then
   error "rIt's there."
fi
